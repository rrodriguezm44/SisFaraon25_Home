...
class ProductosModeloOfertas
{

  static public function mdlListarNombreProductosOfertas()
  {
  ...
  static public function mdlGetDatosProductoOfertas($codigo_producto)
  {
    $stmt = Conexion::conectar()->prepare("SELECT producto_id,
                                                          ...
                                                          CONCAT('Bs. ',CONVERT(ROUND(precio_venta-(precio_venta*descuento/100)*1,2), CHAR)) as subtotal,
                                                          '' as acciones,
                                                          '' as precios,
                                                          ...
                                                          CONCAT('Bs. ',CONVERT(ROUND(precio_venta-(precio_venta*descuento/100)*1,2), CHAR)) as subtotalproductos
                                                  FROM productos p
  ...
  static public function mdlVerificaStockProductoOfertas($codigo_producto, $cantidad_a_comprar)
  {
