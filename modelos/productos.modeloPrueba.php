...
class ProductosModelo
{
  ...
  static public function mdlRegistrarProducto($codigo_producto, $id_categoria, $doc_producto, $descripcion, $precio_compra, $precio_venta, $stock_producto, $id_unidad_medida, $id_proveedor)
  {
