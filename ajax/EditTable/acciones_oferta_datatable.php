...
if ($_POST['action'] == 'edit') {
  ...
  $data = array(
    ...
    'id' => $_POST['detalle_oferta_id']
  );

  $statement = Conexion::conectar()->prepare("Call prc_ActualizaDetalleOferta(:p_codigo_producto,:p_cantidad,:p_id)");
...
if ($_POST['action'] == 'delete') {
  ...
  $statement = Conexion::conectar()->prepare("Call prc_EliminarDetalleOferta(:p_id)");
